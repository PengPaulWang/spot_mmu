...
#         #######
        ...
        for i in range(boxes.shape[0]):
            ...
            # Only consider objects labeled as 'cube'
            if label == 'cube' and scores[i] > max_confidence:
                # Update if this detection has the highest confidence so far
        ...
        # Process the detection with the highest confidence, if any
        if best_detection:
            box = tuple(best_detection["box"].tolist())
            box = [
            ...
            print('Selected object with label: "' + label + '" and score: ' + str(score))
        ...
        print('Processed highest confidence "cube" object with score:', max_confidence)
        ...
        # print(f'this is out_proto = {out_proto}')
        response_queue.put(out_proto)
